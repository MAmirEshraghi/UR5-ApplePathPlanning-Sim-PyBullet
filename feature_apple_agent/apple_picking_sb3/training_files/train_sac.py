...
if __name__ == "__main__":
    ...
    if not load_path:
        ...
        model = SAC.load(load_path, env=env, custom_objects=load_dict)
    ...
    # env.reset()
    model.learn(10_000_000, callback=[train_callback, eval_callback], progress_bar=False, reset_num_timesteps=False)
