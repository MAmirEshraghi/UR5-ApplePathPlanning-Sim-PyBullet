...
if __name__ == "__main__":
    ...
    for i in range(num_trees):
        ...
        for time in range(l.derivationLength):
            ...
            # ============================================================================== #
            # === THE FIX: The plot() call is necessary to build the internal scene      === #
            # ============================================================================== #
            # This call updates the internal scene with the grown objects at each step.
            # Even if you are not viewing the GUI, this step is required.
            l.plot(lstring)
        ...
        # Now that the scene has been fully built by the plot calls, we can
        # interpret the final string to get the complete geometry.
